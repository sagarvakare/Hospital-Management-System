	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="" class="img1" src="img/doc1.jpg">
			</div>
						...
						<form class="row g-3" action="Appointment" method="post">
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Diseases</label> <input
									required type="text" class="form-control" name="diesease">
							</div>
							...
							<c:if test="${empty usermsg }">
								<a href="user.jsp" class="col-md-6 offset-md-3 btn btn-success">Submit</a>
							</c:if>
